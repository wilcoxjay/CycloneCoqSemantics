...
Example SL_3_2_test:
  ltyp (c [] [] ([] ++ [(x,(ptype cint))])) (star (p_e x [])) cint.
Proof.
  apply SL_3_2;
  eauto 20 with Chapter3.
Qed.
...
Example SL_3_3_test:
  ltyp (c [] [] [(x,(cross cint cint))]) (dot (p_e x []) (i_i 0)) cint.
Proof.
...
Example SL_3_4_test:
  ltyp (c [] [] [(x,(cross cint cint))]) (dot (p_e x []) (i_i 1)) cint.
Proof.
...
Example styp_openstar_test:
  styp cnil tau (openstar e alpha x s).
Proof.
...
Example SR_3_2_test:
  rtyp (c [] [] ([]++[(x,(ptype cint))])) (star (p_e x [])) cint.
Proof.
  apply SR_3_2;
  eauto 20 with Chapter3.
Qed.
...
Example SR_3_3_test:
  rtyp (c [] [] []) (dot (cpair (i_e (i_i 0)) (i_e (i_i 1))) (i_i Z0)) cint.
Proof.
...
Example SR_3_7_test:
  rtyp (c [] [] []) (cpair (i_e (i_i 0)) (i_e (i_i 1))) (cross cint cint).
Proof.
  apply SR_3_7;
  eauto 10 with Chapter3.
Qed.
...
Example SR_3_11_test:
  rtyp (c [] [] []) (inst e tau) (subst_Tau tau' tau alpha).
Proof.
